...
func (c *transformerClient) Hermesen(ctx context.Context, in *HermesenReq, opts ...grpc.CallOption) (*HermesResp, error) {
	out := new(HermesResp)
	err := c.cc.Invoke(ctx, "/transform.transformer/hermesen", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TransformerServer interface {
	...
	Hermesen(context.Context, *HermesenReq) (*HermesResp, error)
...
func (UnimplementedTransformerServer) Hermesen(context.Context, *HermesenReq) (*HermesResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Hermesen not implemented")
}
...
func _Transformer_Hermesen_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HermesenReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransformerServer).Hermesen(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/transform.transformer/hermesen",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransformerServer).Hermesen(ctx, req.(*HermesenReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Transformer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "hermesen",
			Handler:    _Transformer_Hermesen_Handler,
		},
	},
